...
const videoPlayer = document.querySelector("#sintel");
activatePlayer(videoPlayer);
const audioPlayer = document.querySelector("#tux");
...
function activatePlayer(player) {
  ...
  const rwd = player.querySelector(".rwd");
  const fwd = player.querySelector(".fwd");

  const timerWrapper = player.querySelector(".timer");
  const timer = player.querySelector(".timer span");
  const timerBar = player.querySelector(".timer div");
